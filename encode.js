...
// Replace with appropriate directory or something I guess
...
function encode(commands, sensor_json) {
    ...
    for (var i = 0; i < categories.length; i++) { // iterates over the categories of commands
        ...
        for (var j = 0; j < groups_and_fields.length; j++) { // iterates over the groups of commands
            ...
            // Now that we have iterated over all of the commands, there are three cases to handle:
            ...
            //  3. The write case where the current key is a group (will require another loop)
